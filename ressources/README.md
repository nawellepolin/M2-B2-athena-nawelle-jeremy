...
> Brief associé : **M2-B2**.
> Mode : binôme sync jeudi (2h15) + individuel async vendredi (6h).
...
### Phase async (vendredi individuel)
...
**Garde-fou** : pas besoin de coder hors jeudi sync + 6h async.
